  ...
  return (
    <main className="min-h-screen">
      ...
      <Button
        size={"lg"}
        variant="outline"
        className="flex my-10 mx-auto bg-yellow-500 px-8 py-6 rounded-xl"
      >
        <Link href={"/books"}>
        ...
        <div className="container mx-auto px-4 ">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-bold mb-4">
              How to SELL your old books online on BookEcom?
            </h2>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 ">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-bold mb-4">
              How to BUY second hand books online on BookEcom?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto ">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => {
              return (
                <Card
                  key={index}
                  className="h-full pt-0 flex flex-col overflow-hidden transition-all duration-300 hover:shadow-lg"
                >
